...
#Define data path
data_path = "C:/collegework/CDSAML2/trimmed_nondupp/"
data_dir_list = os.listdir(data_path)
print(data_dir_list)
map=[[1 for i in range(2)] for j in range(24)]
...
outF = open("C:/collegework/CDSAML/working codes/out/labels.txt", "a")
...
"""Y= np_utils.to_categorical(labels,14)
...
filepath = 'C:/collegework/CDSAML/training/weights-improvement-normalised-reduced-{epoch:02d}-{val_acc:.2f}.hdf5'
checkpoint = ModelCheckpoint(filepath, monitor='val_acc',verbose=1,save_best_only=True,mode='max')
callback_list = [checkpoint]
model.fit(X_train,y_train, epochs=1200, batch_size=32, callbacks=callback_list, validation_data=(X_val,y_val))
