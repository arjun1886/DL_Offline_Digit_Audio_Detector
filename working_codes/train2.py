...
model = Sequential()
model.add(Conv1D(40, kernel_size=, activation='relu', input_shape=shape))
model.add(MaxPooling1D(pool_size=(1, 1)))
...
model.fit(X_train,y_train, epochs=1200, batch_size=40, callbacks=callback_list, validation_data=(X_val,y_val))
